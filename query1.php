...
<body>
    ...
    <div class="content-text">
        <h3>Query 1</h3>
        <p>List all the schools are located in specific Campus and sort them by school name</p>
    </div>
    <div>
        <table>
            <tr>
            ...
            <?php
            $Datas = mysqli_query($koneksi, "SELECT School_Name, Faculty_Name, School_Building
FROM School
WHERE Campus_Name = 'UNY'
ORDER BY School_Name");
            ...
            while ($Data = mysqli_fetch_array($Datas)) {
                ...
                <tr <?php echo $bg?>>
                    ...
                    <td><?php echo $Data["School_Building"] ?></td>
