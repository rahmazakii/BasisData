...
<body>
    ...
    <div class="content-text">
        <h3>Query 2</h3>
        <p>Give all the names of the lecturers who are the members of the committee and sort by their name.</p>
    </div>
    <div>
        <table>
            <tr>
                <th>Lecturer & Committee</th>
            </tr>
            <tbody>
    
            
            <?php
            $Datas = mysqli_query($koneksi, "SELECT Lecturer_Name 
FROM Committee_Lecturer CL
JOIN Lecturer L ON CL.Staff_ID = L.Staff_ID
