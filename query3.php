...
<body>
    ...
    <div class="content-text">
        <h3>Query 3</h3>
        <p>Give all the lecturers with the courses they are teaching. Sort by lecturer name.</p>
    </div>
    <div>
        <table>
            <tr>
            ...
            <?php
            $Datas = mysqli_query($koneksi, "SELECT Lecturer_Name, Course_Title
FROM Lecturer_Course LC
INNER JOIN LECTURER L ON LC.Staff_ID = L.Staff_ID
